...
This file provides guidance to Claude Code (claude.ai/code) when working in `src/addons/HappyBoard/ConvoPlus/_output/template_modifications/public`.

## Scope

This directory belongs to the `HappyBoard/ConvoPlus` add-on (Convo+ by HappyBoard). Relative path inside the add-on: `_output/template_modifications/public`.

## Directory Role

This area contains development output generated from or imported into XenForo development mode.
